...
class wpiExploreTopicsSettings
{
    ...
    function wpi_explore_topic_fields(  ) { 
            ...
            echo "<tr>";
            echo "<td><label for='wpi_taxo_field'><strong>Taxonomy</strong></label></td>";
            echo "<td><select id='wpi_taxo_field' name='wpi_explore_topics_settings[wpi_taxo_field]'>
                <option ";
                if($options['wpi_taxo_field'] == 'tags') echo "selected='selected' ";
            echo ">tags</option>";
            
            echo "<option ";
            if($options['wpi_taxo_field'] == 'categories') echo "selected='selected' ";
